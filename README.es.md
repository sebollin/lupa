...
**magnitud**, en dos números que son cuentas de verdad —`filas_leidas` y
`ordenaciones_completas`— y al imprimirlo avisa cuando el trabajo es
alto, nombrando las palancas para acotarlo. Es una estimación y lo dice:
cuenta las filas que habría que leer si ningún índice ayudara. Los dos
números publicados no dependen de ese supuesto, así que quien no lo
comparta puede rehacer la cuenta.
