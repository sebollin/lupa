...
interpreta en silencio. El formato compacto `%Y%m%d` exige un año entre
1800 y 2100 para evitar que identificadores de ocho dígitos se
clasifiquen parcialmente como fechas.
...
Data frame con formato, frecuencia, proporción, estado y conteos de
