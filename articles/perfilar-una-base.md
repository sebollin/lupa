...
#> 1                n calculado   0.5407333      0                 1              3192
#> 2                n calculado   0.5407333      0                 1              3192
#> 3                n calculado   0.5407333      0                 1              3192
#> 4                n calculado   0.5407333      0                 1              3192
#> 5        n_validos calculado   0.5407333      0                 1              3192
#> 6      n_faltantes calculado   0.5407333      0                 1              3192
#> 7   prop_faltantes calculado   0.5407333      0                 1              3192
#> 8      n_distintos calculado   0.3931522      1                 1              1216
#> 9   tasa_distintos calculado   0.3931522      1                 1              1216
#> 10            moda calculado   0.4208088      0                 1              1024
#> 11 frecuencia_moda calculado   0.4208088      0                 1              1024
#> 12          minimo calculado   0.5407333      0                 1              3192
#> 13          maximo calculado   0.5407333      0                 1              3192
#> 14           media calculado   0.5407333      0                 1              3192
#> 15         n_ceros calculado   0.5407333      0                 1              3192
#> 16     n_negativos calculado   0.5407333      0                 1              3192
#> 17         mediana calculado   0.3631115      1                 1               736
#> 18          desvio calculado   0.5407333      0                 1              3192
#> 19       n_validos calculado   0.5407333      0                 1              3192
#> 20     n_faltantes calculado   0.5407333      0                 1              3192
#> 21  prop_faltantes calculado   0.5407333      0                 1              3192
#> 22     n_distintos calculado   0.3931522      1                 1              1216
#> 23  tasa_distintos calculado   0.3931522      1                 1              1216
#> 24            moda calculado   0.4384518      1                 1              1080
#> 25 frecuencia_moda calculado   0.4384518      1                 1              1080
...
#> 33       n_validos calculado   0.5407333      0                 1              3192
#> 34     n_faltantes calculado   0.5407333      0                 1              3192
#> 35  prop_faltantes calculado   0.5407333      0                 1              3192
#> 36     n_distintos calculado   0.5288124      1                 1              1216
#> 37  tasa_distintos calculado   0.5288124      1                 1              1216
#> 38            moda calculado   0.3726482      1                 1              1024
#> 39 frecuencia_moda calculado   0.3726482      1                 1              1024
#> 40          minimo calculado   0.5407333      0                 1              3192
#> 41          maximo calculado   0.5407333      0                 1              3192
#> 42           media calculado   0.5407333      0                 1              3192
#> 43         n_ceros calculado   0.5407333      0                 1              3192
#> 44     n_negativos calculado   0.5407333      0                 1              3192
#> 45         mediana calculado   0.3414154      1                 1               736
#> 46          desvio calculado   0.5407333      0                 1              3192
#> 47       n_validos calculado   0.5407333      0                 1              3192
#> 48     n_faltantes calculado   0.5407333      0                 1              3192
#> 49  prop_faltantes calculado   0.5407333      0                 1              3192
#> 50     n_distintos calculado   0.5288124      1                 1              1216
#> 51  tasa_distintos calculado   0.5288124      1                 1              1216
#> 52            moda calculado   0.3676414      0                 1              1088
#> 53 frecuencia_moda calculado   0.3676414      0                 1              1088
...
#> 1        ausencia_estructural   0.4901886      1        medido     2             1
#> 2 casi_duplicados_vocabulario   7.6653957     13        medido     2             1
#> 3                dependencias   0.9317398      1        medido     2             1
#> 4      duplicados_aproximados          NA     NA no_solicitado     2             1
#> 5             lectura_muestra   1.2345314      1        medido     1             1
#> 6          perfilado_columnas 214.6286964    213        medido     2             1
#> 7           perfilado_muestra 280.1485062    288        medido     1             1
```
