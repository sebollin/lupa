...
que no es un fallo. Esto vale para los dos universos: con
`muestra_motor`, los agregados se calculan sobre la relación muestreada,
pero no se abre un spool ni se ven filas
(`meta$bloques$filas_vistas = 0`). La lectura habitual se conserva con
`bloque_muestra = "con_muestra"`, que es el valor por omisión; allí la
selección del motor se materializa una sola vez y se reutiliza para todo
el perfil.
...
`perfil_muestra$columnas` trae 112 campos analíticos además del nombre
...
sus 112 sobre las cinco filas obtenidas. Las consultas, estados y
...
#> 1                n calculado   0.7231236      1                 1              3192
#> 2                n calculado   0.7231236      1                 1              3192
#> 3                n calculado   0.7231236      1                 1              3192
#> 4                n calculado   0.7231236      1                 1              3192
#> 5        n_validos calculado   0.7231236      1                 1              3192
#> 6      n_faltantes calculado   0.7231236      1                 1              3192
#> 7   prop_faltantes calculado   0.7231236      1                 1              3192
#> 8      n_distintos calculado  90.4982090     91                 1              1216
#> 9   tasa_distintos calculado  90.4982090     91                 1              1216
#> 10            moda calculado   0.5002022      0                 1              1024
#> 11 frecuencia_moda calculado   0.5002022      0                 1              1024
#> 12          minimo calculado   0.7231236      1                 1              3192
#> 13          maximo calculado   0.7231236      1                 1              3192
#> 14           media calculado   0.7231236      1                 1              3192
#> 15         n_ceros calculado   0.7231236      1                 1              3192
#> 16     n_negativos calculado   0.7231236      1                 1              3192
#> 17         mediana calculado   0.4456043      0                 1               736
#> 18          desvio calculado   0.7231236      1                 1              3192
#> 19       n_validos calculado   0.7231236      1                 1              3192
#> 20     n_faltantes calculado   0.7231236      1                 1              3192
#> 21  prop_faltantes calculado   0.7231236      1                 1              3192
#> 22     n_distintos calculado  90.4982090     91                 1              1216
#> 23  tasa_distintos calculado  90.4982090     91                 1              1216
#> 24            moda calculado   0.5249977      0                 1              1080
#> 25 frecuencia_moda calculado   0.5249977      0                 1              1080
...
#> 33       n_validos calculado   0.7231236      1                 1              3192
#> 34     n_faltantes calculado   0.7231236      1                 1              3192
#> 35  prop_faltantes calculado   0.7231236      1                 1              3192
#> 36     n_distintos calculado   0.5507469      1                 1              1216
#> 37  tasa_distintos calculado   0.5507469      1                 1              1216
#> 38            moda calculado   0.4580021      0                 1              1024
#> 39 frecuencia_moda calculado   0.4580021      0                 1              1024
#> 40          minimo calculado   0.7231236      1                 1              3192
#> 41          maximo calculado   0.7231236      1                 1              3192
#> 42           media calculado   0.7231236      1                 1              3192
#> 43         n_ceros calculado   0.7231236      1                 1              3192
#> 44     n_negativos calculado   0.7231236      1                 1              3192
#> 45         mediana calculado   0.5409718      0                 1               736
#> 46          desvio calculado   0.7231236      1                 1              3192
#> 47       n_validos calculado   0.7231236      1                 1              3192
#> 48     n_faltantes calculado   0.7231236      1                 1              3192
#> 49  prop_faltantes calculado   0.7231236      1                 1              3192
#> 50     n_distintos calculado   0.5507469      1                 1              1216
#> 51  tasa_distintos calculado   0.5507469      1                 1              1216
#> 52            moda calculado   0.4687309      0                 1              1088
#> 53 frecuencia_moda calculado   0.4687309      0                 1              1088
...
#> 1        ausencia_estructural   0.7281303      1        medido     2             1
#> 2 casi_duplicados_vocabulario   9.3953609     16        medido     2             1
#> 3                dependencias   1.1599064      2        medido     2             1
#> 4      duplicados_aproximados          NA     NA no_solicitado     2             1
#> 5             lectura_muestra   2.0117760      2        medido     1             1
#> 6          perfilado_columnas 364.0842438    364        medido     2             1
#> 7           perfilado_muestra 463.1152153    474        medido     1             1
```
...
seleccionadas. La salida muestra algunos de sus 112 campos analíticos
...
Las columnas `integer64` tienen una condición equivalente: si `bit64`
está instalado, `lupa` registra sus métodos antes de medir la secuencia;
si falta, las cinco medidas públicas quedan en `NA` y
`cobertura_diagnosticos` deja constancia de que `secuencia_entera` no se
evaluó. En los textos publicados, los números usan notación fija con
precisión completa, independiente de `scipen` y de `digits`, y conservan
`OutDec`.

Las sugerencias de ausencia estructural componen el código con una copia
UTF-8 marcada de cada nombre. El nombre que queda en `columnas$columna`
conserva los bytes y la marca que llegaron desde la tabla; la sugerencia
sigue siendo código para copiar y pegar bajo `LC_CTYPE = "C"`.
