...
que podrían ser valores de una persona se suprimen y la tabla lo marca.
Se suprimen los de orden —mínimo, máximo, mediana, moda— y también la
media, porque sobre pocas filas se acerca a un valor y porque publicarla
junto a otras cifras del mismo perfil permite despejar las que sí se
protegieron. El desvío se mantiene: describe la dispersión sin acercarse
a ninguna fila. La supresión se declara, y distingue el estadístico de
orden del momento.
...
#>              diagnostico      columna
#> 1   resumen_cuantitativo fecha_evento
#> 2 proximidad_vocabulario         zona
#> 3 proximidad_vocabulario     contacto
#> 4 proximidad_vocabulario    id_evento
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                 motivo
#> 1                                                                                                                                                                                                                                                                     El resumen cuantitativo se calculo sobre 11 valores y dejo afuera 2 valores presentes que no pudo convertir; el tipo o formato se descubrio sobre una muestra de 13 de 13 filas.
#> 2 1 grupo de valores cercanos no se informo porque su asimetria de frecuencias quedo por debajo de 2: las formas son casi igual de comunes y no se puede distinguir una errata sistematica de dos valores legitimamente parecidos. 1 grupo de formas cercanas no se formo porque sus frecuencias fueron parecidas: el criterio de variante rara no pudo distinguir una forma correcta de otra. Se identificaron 1 pares cercanos con asimetria <= 2.0.
#> 3                                                                                                                                                                                                                                                                                                                                                                    El grupo candidato mayor abarca 0.917 del vocabulario y el diagnostico no aplica.
#> 4                                                                                                                                                                                                                                                                                                                                                                    El grupo candidato mayor abarca 1.000 del vocabulario y el diagnostico no aplica.
#>                                                                                                                                                                                                                                                                                               como_resolverlo
#> 1                                                                                                                                                                                                      Revisar los valores fuera de la muestra y confirmar el tipo o formato antes de usar el rango completo.
#> 2 Bajar `min_asimetria_vocabulario` si en esta columna interesan las variantes de frecuencia pareja, sabiendo que aumenta el ruido. Activar un detector de formas equifrecuentes con conocimiento del dominio, o revisar los pares manualmente; no se puede elegir una forma correcta solo por su frecuencia.
...
#> 4                                                                                                                                                                                  Usar una regla de dominio especifica para la columna o ajustar el criterio de agrupacion con conocimiento del vocabulario.
#>   dependencia
#> 1        <NA>
#> 2        <NA>
#> 3        <NA>
