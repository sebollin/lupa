...
# ftfy expresa esta restauracion con dos expresiones regulares. Aqui se hace
# byte a byte, que es lo unico que funciona sin suponer la codificacion de
# origen, asi que las dos expresiones no se usan: estuvieron declaradas y
# muertas, con una prueba que las comparaba contra el fixture de ftfy 6.3.1 sin
# tocar el codigo. Lo que comprueba la implementacion son los casos del fixture.
