...
`65029f1202cdbebf22de3ceca3b45adde4c99de4`. The tarball was built from a clean
tree at that commit, which is checkable rather than asserted:

```sh
git rev-parse 65029f1^{commit}   # the revision these sources come from
git status --porcelain            # no output: nothing uncommitted travels in the build
git diff --name-only 65029f1..HEAD   # only cran-comments.md, which .Rbuildignore keeps out
...
<!-- GENERATED by notas-desarrollo/matriz-carta.sh from the logs of 65029f1.
     Do not edit by hand: it is regenerated. -->

**Sources: `65029f1202cdbebf22de3ceca3b45adde4c99de4`.**

| environment | result | log |
| --- | --- | --- |
| local, `_R_CHECK_DEPENDS_ONLY_=true` `--as-cran` | Status: 2 NOTEs | `verificacion/2026-09-13/check-depends-only.log` |
| local, `_R_CHECK_CRAN_INCOMING_=false` `--no-manual` | Status: OK | `verificacion/2026-09-13/check-sin-incoming.log` |
| local, container R 4.1.0 (the declared minimum) | Status: 1 ERROR, 1 WARNING, 3 NOTEs | `verificacion/2026-09-13/contenedor-4.1.0.log` |
| full test suite inside the R 4.1.0 container | [ FAIL 0 \| WARN 0 \| SKIP 38 \| PASS 23956 ] | `verificacion/2026-09-13/contenedor-4.1.0-suite.log` |
| local revalidation, all nine steps | Revalidacion local en verde | `verificacion/2026-09-13/revalidacion-completa.log` |
| engine matrix against real engines | motores medidos: 7 de 7 | `verificacion/2026-09-13/matriz-motores.log` |
| utility battery (recall and precision) | recall: 9 de 9 | `verificacion/2026-09-13/bateria-utilidad.log` |
| GitHub Actions, 5 platforms (macOS release included) | platforms with Status: OK: 5 of 5; FAIL 0 \| WARN 0 on all of them; PASS from 24346 to 24407 | `verificacion/2026-09-13/actions-5-plataformas.log` |
| R-hub v2, Linux (R-devel) | Status: OK | `verificacion/2026-09-13/rhub-linux.log` |
| R-hub v2, Windows (R-devel) | Status: OK
 | `verificacion/2026-09-13/rhub-windows.log` |
| R-hub v2, macOS x86_64 (R-devel) | Failed to build source package s2. | `verificacion/2026-09-13/rhub-macos.log` |
| win-builder release | Status: 1 NOTE
 | `verificacion/2026-09-13/winbuilder-release.log` |
| win-builder devel | Status: 1 NOTE
 | `verificacion/2026-09-13/winbuilder-devel.log` |
...
| --- | ---: | --- |
| R-hub, Linux, R-devel | [18m/17m] | `verificacion/2026-09-13/rhub-linux.log` |
| R-hub, Windows, R-devel | [24m] | `verificacion/2026-09-13/rhub-windows.log` |
| this machine, `_R_CHECK_DEPENDS_ONLY_=true --as-cran` | [270s/269s] | `verificacion/2026-09-13/check-depends-only.log` |

| the suite that produced them | BLOQUES: 1626 FALLOS: 0 ERROR: 0 SKIP: 2 PASS: 24455 | `verificacion/2026-09-13/revalidacion-completa.log` |
